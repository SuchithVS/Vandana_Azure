...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE books SET title=?, author=?, genre=?, published_year=?, isbn=?, image_url=?, status=? WHERE id=?";
    $stmt = mysqli_prepare($link, $sql);
    mysqli_stmt_bind_param($stmt, "sssssssi", $title, $author, $genre, $published_year, $isbn, $image_url, $status, $id);
    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="edit_book.php?id=<?php echo $id; ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="image_url" name="image_url" value="<?php echo htmlspecialchars($book['image_url']); ?>" required>
            </div>
            <div class="mb-3">
